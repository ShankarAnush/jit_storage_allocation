...
MYSQL_CLUSTERIP = os.environ.get('MYSQL_CLUSTERIP', '10.99.72.39')
MYSQL_USERNAME = os.environ.get('MYSQL_USERNAME', 'mysql')
PASSWORD = os.environ.get('$MYSQL_PASSWORD', 'jit@upb123')
...
#        db_cursor = mydb.cursor() # keeping cursor updated
    ...
    db_cursor.execute("""
            ...
            SetTimCyc float,
            InstanceName TEXT,
            TimestampSent TIMESTAMP(6) PRIMARY KEY)""" % (TABLE))
