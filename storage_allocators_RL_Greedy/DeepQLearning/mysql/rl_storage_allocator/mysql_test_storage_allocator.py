...
def main():
    ...
    with open(r'rl_storage_mysql_downtime_reward.csv', 'w') as f:
        writer = csv.writer(f)
        writer.writerow(['rewards', 'downtime'])

    with open(r'rl_storage_mysql_disk_space.csv', 'w') as f:
        writer = csv.writer(f)
    ...
    for t in range(storage_allocator.last_data_index):
        ...
        with open(r'rl_storage_mysql_disk_space.csv', 'a') as f:
            writer = csv.writer(f)
